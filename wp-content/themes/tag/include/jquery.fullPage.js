...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
				...
				$(this).find('.fp-slides').after('<div class="fp-controlArrow fp-prev"><i class="fa fa-arrow-circle-o-left"></i></div><div class="fp-controlArrow fp-next"><i class="fa fa-arrow-circle-o-right"></i></div>');
				...
				slides.each(function(index) {
					var imageUrl = $(this).data('slide-bg');
		...
		/**
		* Prepend a zero in front of any number to fit the length of 2. Customized by Themelovin
		*/
		...
		/**
		* Creates a vertical navigation bar. Customized by Themelovin
		*/
		function addVerticalNavigation(){
			...
			for(var cont = 0; cont < $('.fp-section').length; cont++){
				...
				nav.find('ul').append('<li data-tooltip="' + tooltip + '"><a href="#' + link + '"><span>' + pad(cont, 2) + '</span></a></li>');
			}
		}
		...
		*/
		...
		$.fn.fullpage.moveToFirst = function (){
			var first = $('.fp-section').first();
			scrollPage(first, null, false);
		};
		...
		*/
		...
		function addTableClass(element){
			if(element.hasClass('format-video') && element.find('.thmlvVideoWrap').length) {
				element.addClass('fp-table').wrapInner('<div class="fp-tableCell" style="height:' + getTableHeight(element) + 'px;" />');
				element.prepend('<div class="thmlvPortfolioOverlay"></div>');
			} else {
				element.addClass('fp-table').wrapInner('<div class="fp-tableCell" style="height:' + getTableHeight(element) + 'px;" />');			
			}
		}
		...
		*/
		...
		function playVideo(currentSection){
			var hasVideo = currentSection.find('video');
